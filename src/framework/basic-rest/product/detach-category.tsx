...
async function detachCategoryToProduct(props: AttachCategoryProps) {
    const response = await http.post(API_ENDPOINTS.STORE_PRODUCT_DETACH_CATEGORY + '/' + props.product_id, { id: props.ids });
    return response
}

export const useDetachCategoryTtMutation = () => {
    ...
    return useMutation((input: AttachCategoryProps) => detachCategoryToProduct(input), {
        onSuccess: (data) => {
