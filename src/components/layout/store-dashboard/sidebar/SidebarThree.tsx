...
export default function SidebarThree() {
    return (
        ...
        >
            <div className="sidebar-header flex justify-center mr-[100px] pt-4">
                <div className="">
                    <Logo />
                </div>
            </div>
            <div className="sidebar-content px-4 py-6">
                <ul className="flex flex-col w-full">
                    <li className="my-px">
                        <a
                            href="#"
                            className="flex flex-row items-center h-10 px-3 rounded-lg text-gray-700 text-black"
                        >
                            ...
                            <Link href={ROUTES.DASHBOARD} className="ml-3">Dashboard</Link>
                        </a>
                    </li>
                    <li className="my-px">
                        <span className="flex font-medium text-sm text-black px-4 my-4 uppercase">Projects</span>
                    </li>
                    <li className="my-px">
                        <a
                            href="#"
                            className="flex flex-row items-center h-10 px-3 rounded-lg text-black hover:text-black hover:text-gray-700"
                        >
                            <span className="flex items-center justify-center text-lg text-black">
                                <svg
                                    fill="none"
                    ...
                    <li className="my-px">
                        <span className="flex font-medium text-sm text-black px-4 my-4 uppercase">Account</span>
                    </li>
                    <li className="my-px">
                        <a
                            href="#"
