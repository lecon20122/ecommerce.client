...
export default function CreateProductVariantFormStepTwo() {
            ...
            <div className="flex pb-3">
                ...
                <div className="flex-1">
                    <div className="w-10 h-10 bg-black border-2 border-gray-150 shadow-navigation mx-auto rounded-full text-lg text-white flex items-center">
                        <span className="text-grey-darker text-center w-full"><FaCheck className="w-full fill-current white"></FaCheck></span>
                    </div>
                </div>

                <div className="w-1/6 align-center items-center align-middle content-center flex">
                    <div className="w-full bg-black rounded items-center align-middle align-center flex-1">
                        <div className="bg-black text-xs leading-none py-1 text-center text-grey-darkest rounded w-full"></div>
                    </div>
                </div>
